...
import java.sql.*;
import static com.sms.College.collegeName;
...
class ApplicationForm implements ActionListener
{
	...
	public ApplicationForm()
	{
		...
		t1.setText(College.collegeName.toString());
		...
		l.setIcon(new ImageIcon("E://java/CollegeProject/project/workspace_bg4.jpg"));
